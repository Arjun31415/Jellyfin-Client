...
) -> Result<crate::models::BaseItemDtoQueryResult, Error<GetAlbumArtistsError>> {
...
pub async fn get_artist_by_name(
    ...
    name: &str,
    user_id: Option<&str>,
) -> Result<crate::models::BaseItemDto, Error<GetArtistByNameError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetArtistByNameError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_artists(
    ...
    enable_images: Option<bool>,
    enable_total_record_count: Option<bool>,
) -> Result<crate::models::BaseItemDtoQueryResult, Error<GetArtistsError>> {
    let local_var_configuration = configuration;
