...
pub async fn get_audio_stream(
...
) -> Result<std::path::PathBuf, Error<GetAudioStreamError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetAudioStreamError> =
...
pub async fn get_audio_stream_by_container(
    ...
    context: Option<crate::models::EncodingContext>,
    stream_options: Option<::std::collections::HashMap<String, String>>,
) -> Result<std::path::PathBuf, Error<GetAudioStreamByContainerError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetAudioStreamByContainerError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn head_audio_stream(
    ...
    context: Option<crate::models::EncodingContext>,
    stream_options: Option<::std::collections::HashMap<String, String>>,
) -> Result<std::path::PathBuf, Error<HeadAudioStreamError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<HeadAudioStreamError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn head_audio_stream_by_container(
    ...
    context: Option<crate::models::EncodingContext>,
    stream_options: Option<::std::collections::HashMap<String, String>>,
) -> Result<std::path::PathBuf, Error<HeadAudioStreamByContainerError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<HeadAudioStreamByContainerError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
