...
pub async fn get_all_channel_features(
...
) -> Result<Vec<crate::models::ChannelFeatures>, Error<GetAllChannelFeaturesError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetAllChannelFeaturesError> =
...
pub async fn get_channel_features(
    configuration: &configuration::Configuration,
    channel_id: &str,
) -> Result<crate::models::ChannelFeatures, Error<GetChannelFeaturesError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetChannelFeaturesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_channel_items(
...
) -> Result<crate::models::BaseItemDtoQueryResult, Error<GetChannelItemsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetChannelItemsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_channels(
...
) -> Result<crate::models::BaseItemDtoQueryResult, Error<GetChannelsError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = supports_latest_items {
        local_var_req_builder =
            local_var_req_builder.query(&[("supportsLatestItems", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = supports_media_deletion {
        local_var_req_builder =
            local_var_req_builder.query(&[("supportsMediaDeletion", &local_var_str.to_string())]);
    }
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetChannelsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_latest_channel_items(
...
) -> Result<crate::models::BaseItemDtoQueryResult, Error<GetLatestChannelItemsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetLatestChannelItemsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
