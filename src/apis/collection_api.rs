...
pub async fn add_to_collection(
    ...
    collection_id: &str,
    ids: Vec<uuid::Uuid>,
) -> Result<(), Error<AddToCollectionError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AddToCollectionError> =
...
) -> Result<crate::models::CollectionCreationResult, Error<CreateCollectionError>> {
    let local_var_configuration = configuration;
...
pub async fn remove_from_collection(
    ...
    collection_id: &str,
    ids: Vec<uuid::Uuid>,
) -> Result<(), Error<RemoveFromCollectionError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<RemoveFromCollectionError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
