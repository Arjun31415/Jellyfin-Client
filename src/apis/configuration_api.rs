...
) -> Result<crate::models::ServerConfiguration, Error<GetConfigurationError>> {
...
pub async fn get_default_metadata_options(
    configuration: &configuration::Configuration,
) -> Result<crate::models::MetadataOptions, Error<GetDefaultMetadataOptionsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetDefaultMetadataOptionsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_named_configuration(
    configuration: &configuration::Configuration,
    key: &str,
) -> Result<std::path::PathBuf, Error<GetNamedConfigurationError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetNamedConfigurationError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn update_configuration(
    configuration: &configuration::Configuration,
    server_configuration: crate::models::ServerConfiguration,
) -> Result<(), Error<UpdateConfigurationError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdateConfigurationError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn update_media_encoder_path(
    configuration: &configuration::Configuration,
    media_encoder_path_dto: crate::models::MediaEncoderPathDto,
) -> Result<(), Error<UpdateMediaEncoderPathError>> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder = local_var_req_builder.json(&media_encoder_path_dto);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdateMediaEncoderPathError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn update_named_configuration(
...
) -> Result<(), Error<UpdateNamedConfigurationError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdateNamedConfigurationError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
