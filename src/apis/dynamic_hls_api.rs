...
pub async fn get_hls_audio_segment(
    ...
    subtitle_method: Option<crate::models::SubtitleDeliveryMethod>,
    ...
    context: Option<crate::models::EncodingContext>,
    stream_options: Option<::std::collections::HashMap<String, String>>,
) -> Result<std::path::PathBuf, Error<GetHlsAudioSegmentError>> {
    ...
    let local_var_uri_str = format!(
        ...
        playlistId = crate::apis::urlencode(playlist_id),
    ...
    local_var_req_builder =
        local_var_req_builder.query(&[("runtimeTicks", &runtime_ticks.to_string())]);
    local_var_req_builder = local_var_req_builder.query(&[(
        "actualSegmentLengthTicks",
        &actual_segment_length_ticks.to_string(),
    )]);
    if let Some(ref local_var_str) = r#static {
        local_var_req_builder = local_var_req_builder
            .query(&[("static", serde_json::to_string(&local_var_str).unwrap())]);
    }
    if let Some(ref local_var_str) = params {
        local_var_req_builder = local_var_req_builder
            .query(&[("params", serde_json::to_string(&local_var_str).unwrap())]);
    }
    if let Some(ref local_var_str) = tag {
        local_var_req_builder =
            local_var_req_builder.query(&[("tag", serde_json::to_string(&local_var_str).unwrap())]);
    }
    if let Some(ref local_var_str) = device_profile_id {
        local_var_req_builder = local_var_req_builder.query(&[(
            "deviceProfileId",
            serde_json::to_string(&local_var_str).unwrap(),
        )]);
    }
    ...
    if let Some(ref local_var_str) = device_id {
        local_var_req_builder = local_var_req_builder
            .query(&[("deviceId", serde_json::to_string(&local_var_str).unwrap())]);
    }
    if let Some(ref local_var_str) = audio_codec {
        local_var_req_builder = local_var_req_builder
            .query(&[("audioCodec", serde_json::to_string(&local_var_str).unwrap())]);
    }
    ...
    if let Some(ref local_var_str) = profile {
        local_var_req_builder = local_var_req_builder
            .query(&[("profile", serde_json::to_string(&local_var_str).unwrap())]);
    }
    if let Some(ref local_var_str) = level {
        local_var_req_builder = local_var_req_builder
            .query(&[("level", serde_json::to_string(&local_var_str).unwrap())]);
    }
    if let Some(ref local_var_str) = framerate {
        local_var_req_builder = local_var_req_builder
            .query(&[("framerate", serde_json::to_string(&local_var_str).unwrap())]);
    }
    ...
    if let Some(ref local_var_str) = width {
        local_var_req_builder = local_var_req_builder
            .query(&[("width", serde_json::to_string(&local_var_str).unwrap())]);
    }
    if let Some(ref local_var_str) = height {
        local_var_req_builder = local_var_req_builder
            .query(&[("height", serde_json::to_string(&local_var_str).unwrap())]);
    }
    ...
    if let Some(ref local_var_str) = require_avc {
        local_var_req_builder = local_var_req_builder
            .query(&[("requireAvc", serde_json::to_string(&local_var_str).unwrap())]);
    }
    ...
    if let Some(ref local_var_str) = video_codec {
        local_var_req_builder = local_var_req_builder
            .query(&[("videoCodec", serde_json::to_string(&local_var_str).unwrap())]);
    }
    ...
    if let Some(ref local_var_str) = context {
        local_var_req_builder = local_var_req_builder
            .query(&[("context", serde_json::to_string(&local_var_str).unwrap())]);
    }
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetHlsAudioSegmentError> =
...
pub async fn get_hls_video_segment(
    ...
    context: Option<crate::models::EncodingContext>,
    stream_options: Option<::std::collections::HashMap<String, String>>,
) -> Result<std::path::PathBuf, Error<GetHlsVideoSegmentError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = max_width {
        local_var_req_builder = local_var_req_builder
            .query(&[("maxWidth", serde_json::to_string(&local_var_str).unwrap())]);
    }
    if let Some(ref local_var_str) = max_height {
        local_var_req_builder = local_var_req_builder
            .query(&[("maxHeight", serde_json::to_string(&local_var_str).unwrap())]);
    }
    if let Some(ref local_var_str) = video_bit_rate {
        local_var_req_builder = local_var_req_builder.query(&[(
            "videoBitRate",
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetHlsVideoSegmentError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_live_hls_stream(
...
) -> Result<std::path::PathBuf, Error<GetLiveHlsStreamError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = container {
        local_var_req_builder = local_var_req_builder
            .query(&[("container", serde_json::to_string(&local_var_str).unwrap())]);
    }
    if let Some(ref local_var_str) = r#static {
        local_var_req_builder = local_var_req_builder
            .query(&[("static", serde_json::to_string(&local_var_str).unwrap())]);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetLiveHlsStreamError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_master_hls_audio_playlist(
...
) -> Result<std::path::PathBuf, Error<GetMasterHlsAudioPlaylistError>> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder =
        local_var_req_builder.query(&[("mediaSourceId", &media_source_id.to_string())]);
    if let Some(ref local_var_str) = device_id {
        local_var_req_builder = local_var_req_builder
            .query(&[("deviceId", serde_json::to_string(&local_var_str).unwrap())]);
    }
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetMasterHlsAudioPlaylistError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_master_hls_video_playlist(
    ...
    stream_options: Option<::std::collections::HashMap<String, String>>,
    enable_adaptive_bitrate_streaming: Option<bool>,
) -> Result<std::path::PathBuf, Error<GetMasterHlsVideoPlaylistError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetMasterHlsVideoPlaylistError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_variant_hls_audio_playlist(
    ...
    context: Option<crate::models::EncodingContext>,
    stream_options: Option<::std::collections::HashMap<String, String>>,
) -> Result<std::path::PathBuf, Error<GetVariantHlsAudioPlaylistError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetVariantHlsAudioPlaylistError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_variant_hls_video_playlist(
    ...
    context: Option<crate::models::EncodingContext>,
    stream_options: Option<::std::collections::HashMap<String, String>>,
) -> Result<std::path::PathBuf, Error<GetVariantHlsVideoPlaylistError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetVariantHlsVideoPlaylistError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn head_master_hls_audio_playlist(
    ...
    stream_options: Option<::std::collections::HashMap<String, String>>,
    enable_adaptive_bitrate_streaming: Option<bool>,
) -> Result<std::path::PathBuf, Error<HeadMasterHlsAudioPlaylistError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<HeadMasterHlsAudioPlaylistError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn head_master_hls_video_playlist(
    ...
    stream_options: Option<::std::collections::HashMap<String, String>>,
    enable_adaptive_bitrate_streaming: Option<bool>,
) -> Result<std::path::PathBuf, Error<HeadMasterHlsVideoPlaylistError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<HeadMasterHlsVideoPlaylistError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
