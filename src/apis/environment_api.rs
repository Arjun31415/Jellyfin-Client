...
pub async fn get_default_directory_browser(
...
) -> Result<crate::models::DefaultDirectoryBrowserInfoDto, Error<GetDefaultDirectoryBrowserError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetDefaultDirectoryBrowserError> =
...
pub async fn get_directory_contents(
...
) -> Result<Vec<crate::models::FileSystemEntryInfo>, Error<GetDirectoryContentsError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = include_files {
        local_var_req_builder =
            local_var_req_builder.query(&[("includeFiles", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = include_directories {
        local_var_req_builder =
            local_var_req_builder.query(&[("includeDirectories", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetDirectoryContentsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_drives(
    configuration: &configuration::Configuration,
) -> Result<Vec<crate::models::FileSystemEntryInfo>, Error<GetDrivesError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetDrivesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_network_shares(
    configuration: &configuration::Configuration,
) -> Result<Vec<crate::models::FileSystemEntryInfo>, Error<GetNetworkSharesError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetNetworkSharesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_parent_path(
    configuration: &configuration::Configuration,
    path: &str,
) -> Result<String, Error<GetParentPathError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetParentPathError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn validate_path(
    configuration: &configuration::Configuration,
    validate_path_dto: crate::models::ValidatePathDto,
) -> Result<(), Error<ValidatePathError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ValidatePathError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
