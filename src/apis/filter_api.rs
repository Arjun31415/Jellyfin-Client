...
pub async fn get_query_filters(
...
) -> Result<crate::models::QueryFilters, Error<GetQueryFiltersError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetQueryFiltersError> =
...
pub async fn get_query_filters_legacy(
...
) -> Result<crate::models::QueryFiltersLegacy, Error<GetQueryFiltersLegacyError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetQueryFiltersLegacyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
