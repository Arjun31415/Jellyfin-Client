...
pub async fn get_hls_audio_segment_legacy_aac(
    ...
    item_id: &str,
    segment_id: &str,
) -> Result<std::path::PathBuf, Error<GetHlsAudioSegmentLegacyAacError>> {
    ...
    let local_var_uri_str = format!(
        ...
        segmentId = crate::apis::urlencode(segment_id)
    );
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetHlsAudioSegmentLegacyAacError> =
...
pub async fn get_hls_audio_segment_legacy_mp3(
    ...
    item_id: &str,
    segment_id: &str,
) -> Result<std::path::PathBuf, Error<GetHlsAudioSegmentLegacyMp3Error>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetHlsAudioSegmentLegacyMp3Error> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_hls_playlist_legacy(
    ...
    item_id: &str,
    playlist_id: &str,
) -> Result<std::path::PathBuf, Error<GetHlsPlaylistLegacyError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetHlsPlaylistLegacyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_hls_video_segment_legacy(
...
) -> Result<std::path::PathBuf, Error<GetHlsVideoSegmentLegacyError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!(
        ...
        playlistId = crate::apis::urlencode(playlist_id),
        segmentId = crate::apis::urlencode(segment_id),
        segmentContainer = crate::apis::urlencode(segment_container)
    );
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetHlsVideoSegmentLegacyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn stop_encoding_process(
    ...
    device_id: &str,
    play_session_id: &str,
) -> Result<(), Error<StopEncodingProcessError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<StopEncodingProcessError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
