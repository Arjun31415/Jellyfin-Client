...
pub async fn apply_search_criteria(
    ...
    item_id: &str,
    remote_search_result: crate::models::RemoteSearchResult,
    replace_all_images: Option<bool>,
) -> Result<(), Error<ApplySearchCriteriaError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ApplySearchCriteriaError> =
...
pub async fn get_book_remote_search_results(
    configuration: &configuration::Configuration,
    book_info_remote_search_query: crate::models::BookInfoRemoteSearchQuery,
) -> Result<Vec<crate::models::RemoteSearchResult>, Error<GetBookRemoteSearchResultsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetBookRemoteSearchResultsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_box_set_remote_search_results(
    configuration: &configuration::Configuration,
    box_set_info_remote_search_query: crate::models::BoxSetInfoRemoteSearchQuery,
) -> Result<Vec<crate::models::RemoteSearchResult>, Error<GetBoxSetRemoteSearchResultsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetBoxSetRemoteSearchResultsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_external_id_infos(
    configuration: &configuration::Configuration,
    item_id: &str,
) -> Result<Vec<crate::models::ExternalIdInfo>, Error<GetExternalIdInfosError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetExternalIdInfosError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_movie_remote_search_results(
    configuration: &configuration::Configuration,
    movie_info_remote_search_query: crate::models::MovieInfoRemoteSearchQuery,
) -> Result<Vec<crate::models::RemoteSearchResult>, Error<GetMovieRemoteSearchResultsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetMovieRemoteSearchResultsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_music_album_remote_search_results(
    configuration: &configuration::Configuration,
    album_info_remote_search_query: crate::models::AlbumInfoRemoteSearchQuery,
) -> Result<Vec<crate::models::RemoteSearchResult>, Error<GetMusicAlbumRemoteSearchResultsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetMusicAlbumRemoteSearchResultsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_music_artist_remote_search_results(
    configuration: &configuration::Configuration,
    artist_info_remote_search_query: crate::models::ArtistInfoRemoteSearchQuery,
) -> Result<Vec<crate::models::RemoteSearchResult>, Error<GetMusicArtistRemoteSearchResultsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetMusicArtistRemoteSearchResultsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_music_video_remote_search_results(
    configuration: &configuration::Configuration,
    music_video_info_remote_search_query: crate::models::MusicVideoInfoRemoteSearchQuery,
) -> Result<Vec<crate::models::RemoteSearchResult>, Error<GetMusicVideoRemoteSearchResultsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetMusicVideoRemoteSearchResultsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_person_remote_search_results(
    configuration: &configuration::Configuration,
    person_lookup_info_remote_search_query: crate::models::PersonLookupInfoRemoteSearchQuery,
) -> Result<Vec<crate::models::RemoteSearchResult>, Error<GetPersonRemoteSearchResultsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetPersonRemoteSearchResultsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_series_remote_search_results(
    configuration: &configuration::Configuration,
    series_info_remote_search_query: crate::models::SeriesInfoRemoteSearchQuery,
) -> Result<Vec<crate::models::RemoteSearchResult>, Error<GetSeriesRemoteSearchResultsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetSeriesRemoteSearchResultsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_trailer_remote_search_results(
    configuration: &configuration::Configuration,
    trailer_info_remote_search_query: crate::models::TrailerInfoRemoteSearchQuery,
) -> Result<Vec<crate::models::RemoteSearchResult>, Error<GetTrailerRemoteSearchResultsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetTrailerRemoteSearchResultsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
