...
pub async fn get_metadata_editor_info(
    ...
    item_id: &str,
) -> Result<crate::models::MetadataEditorInfo, Error<GetMetadataEditorInfoError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetMetadataEditorInfoError> =
...
pub async fn update_item(
    configuration: &configuration::Configuration,
    item_id: &str,
    base_item_dto: crate::models::BaseItemDto,
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdateItemError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn update_item_content_type(
...
) -> Result<(), Error<UpdateItemContentTypeError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdateItemContentTypeError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
