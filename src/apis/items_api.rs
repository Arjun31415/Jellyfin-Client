...
pub async fn get_items(
    ...
    is_hd: Option<bool>,
    is4_k: Option<bool>,
    location_types: Option<Vec<crate::models::LocationType>>,
    exclude_location_types: Option<Vec<crate::models::LocationType>>,
    ...
    min_date_last_saved_for_user: Option<String>,
    ...
    exclude_item_types: Option<Vec<crate::models::BaseItemKind>>,
    include_item_types: Option<Vec<crate::models::BaseItemKind>>,
    filters: Option<Vec<crate::models::ItemFilter>>,
    is_favorite: Option<bool>,
    media_types: Option<Vec<String>>,
    image_types: Option<Vec<crate::models::ImageType>>,
    ...
    video_types: Option<Vec<crate::models::VideoType>>,
    ...
    is3_d: Option<bool>,
    series_status: Option<Vec<crate::models::SeriesStatus>>,
...
) -> Result<crate::models::BaseItemDtoQueryResult, Error<GetItemsError>> {
    ...
    if let Some(ref local_var_str) = max_official_rating {
        local_var_req_builder =
            local_var_req_builder.query(&[("maxOfficialRating", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = has_theme_song {
        local_var_req_builder =
            local_var_req_builder.query(&[("hasThemeSong", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = has_theme_video {
        local_var_req_builder =
            local_var_req_builder.query(&[("hasThemeVideo", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = has_subtitles {
        local_var_req_builder =
            local_var_req_builder.query(&[("hasSubtitles", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = has_special_feature {
        local_var_req_builder =
            local_var_req_builder.query(&[("hasSpecialFeature", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = has_trailer {
        local_var_req_builder =
            local_var_req_builder.query(&[("hasTrailer", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = adjacent_to {
        local_var_req_builder =
            local_var_req_builder.query(&[("adjacentTo", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = parent_index_number {
        local_var_req_builder =
            local_var_req_builder.query(&[("parentIndexNumber", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = has_parental_rating {
        local_var_req_builder =
            local_var_req_builder.query(&[("hasParentalRating", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = is_hd {
        local_var_req_builder =
            local_var_req_builder.query(&[("isHd", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = is4_k {
        local_var_req_builder =
            local_var_req_builder.query(&[("is4K", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = location_types {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(
                &local_var_str
                    .into_iter()
                    .map(|p| ("locationTypes".to_owned(), p.to_string()))
    ...
    if let Some(ref local_var_str) = exclude_location_types {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(
                &local_var_str
                    .into_iter()
                    .map(|p| ("excludeLocationTypes".to_owned(), p.to_string()))
                    .collect::<Vec<(std::string::String, std::string::String)>>(),
            ),
            _ => local_var_req_builder.query(&[(
    ...
    if let Some(ref local_var_str) = is_missing {
        local_var_req_builder =
            local_var_req_builder.query(&[("isMissing", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = is_unaired {
        local_var_req_builder =
            local_var_req_builder.query(&[("isUnaired", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = min_community_rating {
        local_var_req_builder =
            local_var_req_builder.query(&[("minCommunityRating", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = min_critic_rating {
        local_var_req_builder =
            local_var_req_builder.query(&[("minCriticRating", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = min_premiere_date {
        local_var_req_builder =
            local_var_req_builder.query(&[("minPremiereDate", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = min_date_last_saved {
        local_var_req_builder =
            local_var_req_builder.query(&[("minDateLastSaved", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = min_date_last_saved_for_user {
        local_var_req_builder =
            local_var_req_builder.query(&[("minDateLastSavedForUser", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = max_premiere_date {
        local_var_req_builder =
            local_var_req_builder.query(&[("maxPremiereDate", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = has_overview {
        local_var_req_builder =
            local_var_req_builder.query(&[("hasOverview", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = has_imdb_id {
        local_var_req_builder =
            local_var_req_builder.query(&[("hasImdbId", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = has_tmdb_id {
        local_var_req_builder =
            local_var_req_builder.query(&[("hasTmdbId", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = has_tvdb_id {
        local_var_req_builder =
            local_var_req_builder.query(&[("hasTvdbId", &local_var_str.to_string())]);
    }
    ...
    if let Some(ref local_var_str) = exclude_item_ids {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(
                &local_var_str
                    .into_iter()
                    .map(|p| ("excludeItemIds".to_owned(), p.to_string()))
                    .collect::<Vec<(std::string::String, std::string::String)>>(),
            ),
            _ => local_var_req_builder.query(&[(
                "excludeItemIds",
    ...
    if let Some(ref local_var_str) = image_types {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(
                &local_var_str
                    .into_iter()
                    .map(|p| ("imageTypes".to_owned(), p.to_string()))
                    .collect::<Vec<(std::string::String, std::string::String)>>(),
            ),
            _ => local_var_req_builder.query(&[(
                "imageTypes",
    ...
    if let Some(ref local_var_str) = official_ratings {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(
                &local_var_str
                    .into_iter()
                    .map(|p| ("officialRatings".to_owned(), p.to_string()))
                    .collect::<Vec<(std::string::String, std::string::String)>>(),
            ),
            _ => local_var_req_builder.query(&[(
                "officialRatings",
    ...
    if let Some(ref local_var_str) = years {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(
                &local_var_str
                    .into_iter()
                    .map(|p| ("years".to_owned(), p.to_string()))
                    .collect::<Vec<(std::string::String, std::string::String)>>(),
            ),
            _ => local_var_req_builder.query(&[(
                "years",
    ...
    if let Some(ref local_var_str) = person {
        local_var_req_builder =
            local_var_req_builder.query(&[("person", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = person_ids {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(
                &local_var_str
                    .into_iter()
                    .map(|p| ("personIds".to_owned(), p.to_string()))
                    .collect::<Vec<(std::string::String, std::string::String)>>(),
            ),
            _ => local_var_req_builder.query(&[(
                "personIds",
    ...
    if let Some(ref local_var_str) = person_types {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(
                &local_var_str
                    .into_iter()
                    .map(|p| ("personTypes".to_owned(), p.to_string()))
                    .collect::<Vec<(std::string::String, std::string::String)>>(),
            ),
            _ => local_var_req_builder.query(&[(
                "personTypes",
    ...
    if let Some(ref local_var_str) = studios {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(
                &local_var_str
                    .into_iter()
                    .map(|p| ("studios".to_owned(), p.to_string()))
                    .collect::<Vec<(std::string::String, std::string::String)>>(),
            ),
            _ => local_var_req_builder.query(&[(
                "studios",
    ...
    if let Some(ref local_var_str) = artists {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(
                &local_var_str
                    .into_iter()
                    .map(|p| ("artists".to_owned(), p.to_string()))
                    .collect::<Vec<(std::string::String, std::string::String)>>(),
            ),
            _ => local_var_req_builder.query(&[(
                "artists",
    ...
    if let Some(ref local_var_str) = exclude_artist_ids {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(
                &local_var_str
                    .into_iter()
                    .map(|p| ("excludeArtistIds".to_owned(), p.to_string()))
                    .collect::<Vec<(std::string::String, std::string::String)>>(),
            ),
            _ => local_var_req_builder.query(&[(
                "excludeArtistIds",
    ...
    if let Some(ref local_var_str) = artist_ids {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(
                &local_var_str
                    .into_iter()
                    .map(|p| ("artistIds".to_owned(), p.to_string()))
                    .collect::<Vec<(std::string::String, std::string::String)>>(),
            ),
            _ => local_var_req_builder.query(&[(
                "artistIds",
    ...
    if let Some(ref local_var_str) = album_artist_ids {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(
                &local_var_str
                    .into_iter()
                    .map(|p| ("albumArtistIds".to_owned(), p.to_string()))
                    .collect::<Vec<(std::string::String, std::string::String)>>(),
            ),
            _ => local_var_req_builder.query(&[(
                "albumArtistIds",
    ...
    if let Some(ref local_var_str) = contributing_artist_ids {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(
                &local_var_str
                    .into_iter()
                    .map(|p| ("contributingArtistIds".to_owned(), p.to_string()))
                    .collect::<Vec<(std::string::String, std::string::String)>>(),
            ),
            _ => local_var_req_builder.query(&[(
    ...
    if let Some(ref local_var_str) = albums {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(
                &local_var_str
                    .into_iter()
                    .map(|p| ("albums".to_owned(), p.to_string()))
                    .collect::<Vec<(std::string::String, std::string::String)>>(),
            ),
            _ => local_var_req_builder.query(&[(
                "albums",
    ...
    if let Some(ref local_var_str) = album_ids {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(
                &local_var_str
                    .into_iter()
                    .map(|p| ("albumIds".to_owned(), p.to_string()))
                    .collect::<Vec<(std::string::String, std::string::String)>>(),
            ),
            _ => local_var_req_builder.query(&[(
                "albumIds",
    ...
    if let Some(ref local_var_str) = video_types {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(
                &local_var_str
                    .into_iter()
                    .map(|p| ("videoTypes".to_owned(), p.to_string()))
                    .collect::<Vec<(std::string::String, std::string::String)>>(),
            ),
            _ => local_var_req_builder.query(&[(
                "videoTypes",
    ...
    if let Some(ref local_var_str) = min_official_rating {
        local_var_req_builder =
            local_var_req_builder.query(&[("minOfficialRating", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = is_locked {
        local_var_req_builder =
            local_var_req_builder.query(&[("isLocked", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = is_place_holder {
        local_var_req_builder =
            local_var_req_builder.query(&[("isPlaceHolder", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = has_official_rating {
        local_var_req_builder =
            local_var_req_builder.query(&[("hasOfficialRating", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = collapse_box_set_items {
        local_var_req_builder =
            local_var_req_builder.query(&[("collapseBoxSetItems", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = min_width {
        local_var_req_builder =
            local_var_req_builder.query(&[("minWidth", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = min_height {
        local_var_req_builder =
            local_var_req_builder.query(&[("minHeight", &local_var_str.to_string())]);
    }
    ...
    if let Some(ref local_var_str) = is3_d {
        local_var_req_builder =
            local_var_req_builder.query(&[("is3D", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = series_status {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(
                &local_var_str
                    .into_iter()
                    .map(|p| ("seriesStatus".to_owned(), p.to_string()))
                    .collect::<Vec<(std::string::String, std::string::String)>>(),
            ),
            _ => local_var_req_builder.query(&[(
                "seriesStatus",
    ...
    if let Some(ref local_var_str) = studio_ids {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(
                &local_var_str
                    .into_iter()
                    .map(|p| ("studioIds".to_owned(), p.to_string()))
                    .collect::<Vec<(std::string::String, std::string::String)>>(),
            ),
            _ => local_var_req_builder.query(&[(
                "studioIds",
...
pub async fn get_items_by_user_id(
    ...
    enable_total_record_count: Option<bool>,
    enable_images: Option<bool>,
) -> Result<crate::models::BaseItemDtoQueryResult, Error<GetItemsByUserIdError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetItemsByUserIdError> =
...
pub async fn get_resume_items(
...
) -> Result<crate::models::BaseItemDtoQueryResult, Error<GetResumeItemsError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = exclude_active_sessions {
        local_var_req_builder =
            local_var_req_builder.query(&[("excludeActiveSessions", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetResumeItemsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
