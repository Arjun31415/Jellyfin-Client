...
pub async fn delete_items(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeleteItemsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_ancestors(
    ...
    item_id: &str,
    user_id: Option<&str>,
) -> Result<Vec<crate::models::BaseItemDto>, Error<GetAncestorsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetAncestorsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_critic_reviews(
    configuration: &configuration::Configuration,
    item_id: &str,
) -> Result<crate::models::BaseItemDtoQueryResult, Error<GetCriticReviewsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetCriticReviewsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_download(
    configuration: &configuration::Configuration,
    item_id: &str,
) -> Result<std::path::PathBuf, Error<GetDownloadError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetDownloadError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_item_counts(
...
) -> Result<crate::models::ItemCounts, Error<GetItemCountsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetItemCountsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_library_options_info(
    configuration: &configuration::Configuration,
    library_content_type: Option<&str>,
    is_new_library: Option<bool>,
) -> Result<crate::models::LibraryOptionsResultDto, Error<GetLibraryOptionsInfoError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = library_content_type {
        local_var_req_builder =
            local_var_req_builder.query(&[("libraryContentType", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = is_new_library {
        local_var_req_builder =
            local_var_req_builder.query(&[("isNewLibrary", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetLibraryOptionsInfoError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_media_folders(
...
) -> Result<crate::models::BaseItemDtoQueryResult, Error<GetMediaFoldersError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = is_hidden {
        local_var_req_builder =
            local_var_req_builder.query(&[("isHidden", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetMediaFoldersError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_physical_paths(
    configuration: &configuration::Configuration,
) -> Result<Vec<String>, Error<GetPhysicalPathsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetPhysicalPathsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
) -> Result<crate::models::BaseItemDtoQueryResult, Error<GetSimilarAlbumsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_similar_artists(
    ...
    limit: Option<i32>,
    fields: Option<Vec<crate::models::ItemFields>>,
) -> Result<crate::models::BaseItemDtoQueryResult, Error<GetSimilarArtistsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetSimilarArtistsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_similar_items(
    ...
    limit: Option<i32>,
    fields: Option<Vec<crate::models::ItemFields>>,
) -> Result<crate::models::BaseItemDtoQueryResult, Error<GetSimilarItemsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetSimilarItemsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_similar_movies(
    ...
    limit: Option<i32>,
    fields: Option<Vec<crate::models::ItemFields>>,
) -> Result<crate::models::BaseItemDtoQueryResult, Error<GetSimilarMoviesError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetSimilarMoviesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_similar_shows(
    ...
    limit: Option<i32>,
    fields: Option<Vec<crate::models::ItemFields>>,
) -> Result<crate::models::BaseItemDtoQueryResult, Error<GetSimilarShowsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetSimilarShowsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_similar_trailers(
    ...
    limit: Option<i32>,
    fields: Option<Vec<crate::models::ItemFields>>,
) -> Result<crate::models::BaseItemDtoQueryResult, Error<GetSimilarTrailersError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetSimilarTrailersError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_theme_media(
...
) -> Result<crate::models::AllThemeMediaResult, Error<GetThemeMediaError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = inherit_from_parent {
        local_var_req_builder =
            local_var_req_builder.query(&[("inheritFromParent", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetThemeMediaError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_theme_songs(
    ...
    user_id: Option<&str>,
    inherit_from_parent: Option<bool>,
) -> Result<crate::models::ThemeMediaResult, Error<GetThemeSongsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetThemeSongsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_theme_videos(
    ...
    user_id: Option<&str>,
    inherit_from_parent: Option<bool>,
) -> Result<crate::models::ThemeMediaResult, Error<GetThemeVideosError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetThemeVideosError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn post_added_movies(
    ...
    tmdb_id: Option<&str>,
    imdb_id: Option<&str>,
) -> Result<(), Error<PostAddedMoviesError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = tmdb_id {
        local_var_req_builder =
            local_var_req_builder.query(&[("tmdbId", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = imdb_id {
        local_var_req_builder =
            local_var_req_builder.query(&[("imdbId", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PostAddedMoviesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn post_added_series(
    configuration: &configuration::Configuration,
    tvdb_id: Option<&str>,
) -> Result<(), Error<PostAddedSeriesError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = tvdb_id {
        local_var_req_builder =
            local_var_req_builder.query(&[("tvdbId", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PostAddedSeriesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn post_updated_media(
    configuration: &configuration::Configuration,
    media_update_info_dto: crate::models::MediaUpdateInfoDto,
) -> Result<(), Error<PostUpdatedMediaError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PostUpdatedMediaError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn post_updated_movies(
    ...
    tmdb_id: Option<&str>,
    imdb_id: Option<&str>,
) -> Result<(), Error<PostUpdatedMoviesError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PostUpdatedMoviesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn post_updated_series(
    configuration: &configuration::Configuration,
    tvdb_id: Option<&str>,
) -> Result<(), Error<PostUpdatedSeriesError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PostUpdatedSeriesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn refresh_library(
    configuration: &configuration::Configuration,
) -> Result<(), Error<RefreshLibraryError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<RefreshLibraryError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
