...
pub async fn add_media_path(
    ...
    media_path_dto: crate::models::MediaPathDto,
    refresh_library: Option<bool>,
) -> Result<(), Error<AddMediaPathError>> {
    ...
    if let Some(ref local_var_str) = refresh_library {
        local_var_req_builder =
            local_var_req_builder.query(&[("refreshLibrary", &local_var_str.to_string())]);
    }
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AddMediaPathError> =
...
pub async fn add_virtual_folder(
    configuration: &configuration::Configuration,
    name: Option<&str>,
    collection_type: Option<crate::models::CollectionTypeOptions>,
    paths: Option<Vec<String>>,
    refresh_library: Option<bool>,
    add_virtual_folder_dto: Option<crate::models::AddVirtualFolderDto>,
) -> Result<(), Error<AddVirtualFolderError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = collection_type {
        local_var_req_builder =
            local_var_req_builder.query(&[("collectionType", &local_var_str.to_string())]);
    }
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AddVirtualFolderError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_virtual_folders(
    configuration: &configuration::Configuration,
) -> Result<Vec<crate::models::VirtualFolderInfo>, Error<GetVirtualFoldersError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetVirtualFoldersError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn remove_media_path(
    ...
    path: Option<&str>,
    refresh_library: Option<bool>,
) -> Result<(), Error<RemoveMediaPathError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<RemoveMediaPathError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn remove_virtual_folder(
    ...
    name: Option<&str>,
    refresh_library: Option<bool>,
) -> Result<(), Error<RemoveVirtualFolderError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<RemoveVirtualFolderError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn rename_virtual_folder(
    ...
    new_name: Option<&str>,
    refresh_library: Option<bool>,
) -> Result<(), Error<RenameVirtualFolderError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = new_name {
        local_var_req_builder =
            local_var_req_builder.query(&[("newName", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = refresh_library {
        local_var_req_builder =
            local_var_req_builder.query(&[("refreshLibrary", &local_var_str.to_string())]);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<RenameVirtualFolderError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn update_library_options(
    configuration: &configuration::Configuration,
    update_library_options_dto: Option<crate::models::UpdateLibraryOptionsDto>,
) -> Result<(), Error<UpdateLibraryOptionsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdateLibraryOptionsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn update_media_path(
    configuration: &configuration::Configuration,
    update_media_path_request_dto: crate::models::UpdateMediaPathRequestDto,
) -> Result<(), Error<UpdateMediaPathError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdateMediaPathError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
