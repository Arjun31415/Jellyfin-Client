...
pub async fn add_listing_provider(
    ...
    listings_provider_info: Option<crate::models::ListingsProviderInfo>,
) -> Result<crate::models::ListingsProviderInfo, Error<AddListingProviderError>> {
    ...
    if let Some(ref local_var_str) = validate_listings {
        local_var_req_builder =
            local_var_req_builder.query(&[("validateListings", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = validate_login {
        local_var_req_builder =
            local_var_req_builder.query(&[("validateLogin", &local_var_str.to_string())]);
    }
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AddListingProviderError> =
...
pub async fn add_tuner_host(
    configuration: &configuration::Configuration,
    tuner_host_info: Option<crate::models::TunerHostInfo>,
) -> Result<crate::models::TunerHostInfo, Error<AddTunerHostError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AddTunerHostError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn cancel_series_timer(
    configuration: &configuration::Configuration,
    timer_id: &str,
) -> Result<(), Error<CancelSeriesTimerError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!(
        ...
        local_var_configuration.base_path,
        timerId = crate::apis::urlencode(timer_id)
    );
    let mut local_var_req_builder =
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CancelSeriesTimerError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn cancel_timer(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CancelTimerError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn create_series_timer(
    configuration: &configuration::Configuration,
    series_timer_info_dto: Option<crate::models::SeriesTimerInfoDto>,
) -> Result<(), Error<CreateSeriesTimerError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateSeriesTimerError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn create_timer(
    configuration: &configuration::Configuration,
    timer_info_dto: Option<crate::models::TimerInfoDto>,
) -> Result<(), Error<CreateTimerError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateTimerError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn delete_listing_provider(
    configuration: &configuration::Configuration,
    id: Option<&str>,
) -> Result<(), Error<DeleteListingProviderError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeleteListingProviderError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn delete_recording(
    configuration: &configuration::Configuration,
    recording_id: &str,
) -> Result<(), Error<DeleteRecordingError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!(
        ...
        local_var_configuration.base_path,
        recordingId = crate::apis::urlencode(recording_id)
    );
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::DELETE, local_var_uri_str.as_str());
...
pub async fn delete_tuner_host(
    configuration: &configuration::Configuration,
    id: Option<&str>,
) -> Result<(), Error<DeleteTunerHostError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeleteTunerHostError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn discover_tuners(
...
) -> Result<Vec<crate::models::TunerHostInfo>, Error<DiscoverTunersError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = new_devices_only {
        local_var_req_builder =
            local_var_req_builder.query(&[("newDevicesOnly", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DiscoverTunersError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn discvover_tuners(
    configuration: &configuration::Configuration,
    new_devices_only: Option<bool>,
) -> Result<Vec<crate::models::TunerHostInfo>, Error<DiscvoverTunersError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DiscvoverTunersError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_channel(
    ...
    channel_id: &str,
    user_id: Option<&str>,
) -> Result<crate::models::BaseItemDto, Error<GetChannelError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!(
        ...
        local_var_configuration.base_path,
        channelId = crate::apis::urlencode(channel_id)
    );
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetChannelError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_channel_mapping_options(
...
) -> Result<crate::models::ChannelMappingOptionsDto, Error<GetChannelMappingOptionsError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = provider_id {
        local_var_req_builder =
            local_var_req_builder.query(&[("providerId", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetChannelMappingOptionsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_default_listing_provider(
    configuration: &configuration::Configuration,
) -> Result<crate::models::ListingsProviderInfo, Error<GetDefaultListingProviderError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetDefaultListingProviderError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_default_timer(
...
) -> Result<crate::models::SeriesTimerInfoDto, Error<GetDefaultTimerError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = program_id {
        local_var_req_builder =
            local_var_req_builder.query(&[("programId", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetDefaultTimerError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_guide_info(
    configuration: &configuration::Configuration,
) -> Result<crate::models::GuideInfo, Error<GetGuideInfoError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetGuideInfoError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_lineups(
    ...
    location: Option<&str>,
    country: Option<&str>,
) -> Result<Vec<crate::models::NameIdPair>, Error<GetLineupsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetLineupsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_live_recording_file(
    configuration: &configuration::Configuration,
    recording_id: &str,
) -> Result<std::path::PathBuf, Error<GetLiveRecordingFileError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetLiveRecordingFileError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_live_stream_file(
    ...
    stream_id: &str,
    container: &str,
) -> Result<std::path::PathBuf, Error<GetLiveStreamFileError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!(
        ...
        local_var_configuration.base_path,
        streamId = crate::apis::urlencode(stream_id),
        container = crate::apis::urlencode(container)
    );
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetLiveStreamFileError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_live_tv_channels(
    configuration: &configuration::Configuration,
    r#type: Option<crate::models::ChannelType>,
    user_id: Option<&str>,
    ...
    enable_image_types: Option<Vec<crate::models::ImageType>>,
    fields: Option<Vec<crate::models::ItemFields>>,
    enable_user_data: Option<bool>,
    sort_by: Option<Vec<String>>,
    sort_order: Option<crate::models::SortOrder>,
    enable_favorite_sorting: Option<bool>,
    add_current_program: Option<bool>,
) -> Result<crate::models::BaseItemDtoQueryResult, Error<GetLiveTvChannelsError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = is_liked {
        local_var_req_builder =
            local_var_req_builder.query(&[("isLiked", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = is_disliked {
        local_var_req_builder =
            local_var_req_builder.query(&[("isDisliked", &local_var_str.to_string())]);
    }
    ...
    if let Some(ref local_var_str) = enable_favorite_sorting {
        local_var_req_builder =
            local_var_req_builder.query(&[("enableFavoriteSorting", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = add_current_program {
        local_var_req_builder =
            local_var_req_builder.query(&[("addCurrentProgram", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetLiveTvChannelsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_live_tv_info(
    configuration: &configuration::Configuration,
) -> Result<crate::models::LiveTvInfo, Error<GetLiveTvInfoError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetLiveTvInfoError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_live_tv_programs(
    ...
    limit: Option<i32>,
    sort_by: Option<Vec<String>>,
    sort_order: Option<Vec<crate::models::SortOrder>>,
...
) -> Result<crate::models::BaseItemDtoQueryResult, Error<GetLiveTvProgramsError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = channel_ids {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(
                &local_var_str
                    .into_iter()
                    .map(|p| ("channelIds".to_owned(), p.to_string()))
                    .collect::<Vec<(std::string::String, std::string::String)>>(),
            ),
            _ => local_var_req_builder.query(&[(
                "channelIds",
    ...
    if let Some(ref local_var_str) = min_start_date {
        local_var_req_builder =
            local_var_req_builder.query(&[("minStartDate", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = has_aired {
        local_var_req_builder =
            local_var_req_builder.query(&[("hasAired", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = is_airing {
        local_var_req_builder =
            local_var_req_builder.query(&[("isAiring", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = max_start_date {
        local_var_req_builder =
            local_var_req_builder.query(&[("maxStartDate", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = min_end_date {
        local_var_req_builder =
            local_var_req_builder.query(&[("minEndDate", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = max_end_date {
        local_var_req_builder =
            local_var_req_builder.query(&[("maxEndDate", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = is_movie {
        local_var_req_builder =
            local_var_req_builder.query(&[("isMovie", &local_var_str.to_string())]);
    ...
    if let Some(ref local_var_str) = genres {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(
                &local_var_str
                    .into_iter()
                    .map(|p| ("genres".to_owned(), p.to_string()))
                    .collect::<Vec<(std::string::String, std::string::String)>>(),
            ),
            _ => local_var_req_builder.query(&[(
                "genres",
    ...
    if let Some(ref local_var_str) = genre_ids {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(
                &local_var_str
                    .into_iter()
                    .map(|p| ("genreIds".to_owned(), p.to_string()))
                    .collect::<Vec<(std::string::String, std::string::String)>>(),
            ),
            _ => local_var_req_builder.query(&[(
                "genreIds",
    ...
    if let Some(ref local_var_str) = series_timer_id {
        local_var_req_builder =
            local_var_req_builder.query(&[("seriesTimerId", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = library_series_id {
        local_var_req_builder =
            local_var_req_builder.query(&[("librarySeriesId", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = fields {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetLiveTvProgramsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_program(
    ...
    program_id: &str,
    user_id: Option<&str>,
) -> Result<crate::models::BaseItemDto, Error<GetProgramError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!(
        ...
        local_var_configuration.base_path,
        programId = crate::apis::urlencode(program_id)
    );
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetProgramError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_programs(
    configuration: &configuration::Configuration,
    get_programs_dto: Option<crate::models::GetProgramsDto>,
) -> Result<crate::models::BaseItemDtoQueryResult, Error<GetProgramsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetProgramsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_recommended_programs(
    ...
    enable_user_data: Option<bool>,
    enable_total_record_count: Option<bool>,
) -> Result<crate::models::BaseItemDtoQueryResult, Error<GetRecommendedProgramsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetRecommendedProgramsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_recording(
    ...
    recording_id: &str,
    user_id: Option<&str>,
) -> Result<crate::models::BaseItemDto, Error<GetRecordingError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetRecordingError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_recording_folders(
    configuration: &configuration::Configuration,
    user_id: Option<&str>,
) -> Result<crate::models::BaseItemDtoQueryResult, Error<GetRecordingFoldersError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetRecordingFoldersError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_recording_group(
    configuration: &configuration::Configuration,
    group_id: &str,
) -> Result<(), Error<GetRecordingGroupError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetRecordingGroupError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_recording_groups(
    configuration: &configuration::Configuration,
    user_id: Option<&str>,
) -> Result<crate::models::BaseItemDtoQueryResult, Error<GetRecordingGroupsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetRecordingGroupsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_recordings(
    ...
    start_index: Option<i32>,
    limit: Option<i32>,
    status: Option<crate::models::RecordingStatus>,
    ...
    enable_total_record_count: Option<bool>,
) -> Result<crate::models::BaseItemDtoQueryResult, Error<GetRecordingsError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = channel_id {
        local_var_req_builder =
            local_var_req_builder.query(&[("channelId", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = user_id {
        local_var_req_builder =
            local_var_req_builder.query(&[("userId", &local_var_str.to_string())]);
    ...
    if let Some(ref local_var_str) = is_in_progress {
        local_var_req_builder =
            local_var_req_builder.query(&[("isInProgress", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = series_timer_id {
        local_var_req_builder =
            local_var_req_builder.query(&[("seriesTimerId", &local_var_str.to_string())]);
    ...
    if let Some(ref local_var_str) = is_library_item {
        local_var_req_builder =
            local_var_req_builder.query(&[("isLibraryItem", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = enable_total_record_count {
        local_var_req_builder =
            local_var_req_builder.query(&[("enableTotalRecordCount", &local_var_str.to_string())]);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetRecordingsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_recordings_series(
    ...
    enable_user_data: Option<bool>,
    enable_total_record_count: Option<bool>,
) -> Result<crate::models::BaseItemDtoQueryResult, Error<GetRecordingsSeriesError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetRecordingsSeriesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_schedules_direct_countries(
    configuration: &configuration::Configuration,
) -> Result<std::path::PathBuf, Error<GetSchedulesDirectCountriesError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetSchedulesDirectCountriesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_series_timer(
    configuration: &configuration::Configuration,
    timer_id: &str,
) -> Result<crate::models::SeriesTimerInfoDto, Error<GetSeriesTimerError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetSeriesTimerError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_series_timers(
    ...
    sort_by: Option<&str>,
    sort_order: Option<crate::models::SortOrder>,
) -> Result<crate::models::SeriesTimerInfoDtoQueryResult, Error<GetSeriesTimersError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetSeriesTimersError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_timer(
    configuration: &configuration::Configuration,
    timer_id: &str,
) -> Result<crate::models::TimerInfoDto, Error<GetTimerError>> {
    let local_var_configuration = configuration;
...
pub async fn get_timers(
...
) -> Result<crate::models::TimerInfoDtoQueryResult, Error<GetTimersError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = is_active {
        local_var_req_builder =
            local_var_req_builder.query(&[("isActive", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = is_scheduled {
        local_var_req_builder =
            local_var_req_builder.query(&[("isScheduled", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetTimersError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_tuner_host_types(
    configuration: &configuration::Configuration,
) -> Result<Vec<crate::models::NameIdPair>, Error<GetTunerHostTypesError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetTunerHostTypesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn reset_tuner(
    configuration: &configuration::Configuration,
    tuner_id: &str,
) -> Result<(), Error<ResetTunerError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!(
        ...
        local_var_configuration.base_path,
        tunerId = crate::apis::urlencode(tuner_id)
    );
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ResetTunerError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn set_channel_mapping(
    configuration: &configuration::Configuration,
    set_channel_mapping_dto: crate::models::SetChannelMappingDto,
) -> Result<crate::models::TunerChannelMapping, Error<SetChannelMappingError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SetChannelMappingError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn update_series_timer(
    ...
    timer_id: &str,
    series_timer_info_dto: Option<crate::models::SeriesTimerInfoDto>,
) -> Result<(), Error<UpdateSeriesTimerError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdateSeriesTimerError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn update_timer(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdateTimerError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
