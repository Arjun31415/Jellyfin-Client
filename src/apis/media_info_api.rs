...
pub async fn close_live_stream(
    ...
    live_stream_id: &str,
) -> Result<(), Error<CloseLiveStreamError>> {
    ...
    local_var_req_builder =
        local_var_req_builder.query(&[("liveStreamId", &live_stream_id.to_string())]);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CloseLiveStreamError> =
...
pub async fn get_bitrate_test_bytes(
    configuration: &configuration::Configuration,
    size: Option<i32>,
) -> Result<std::path::PathBuf, Error<GetBitrateTestBytesError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetBitrateTestBytesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_playback_info(
    ...
    item_id: &str,
    user_id: &str,
) -> Result<crate::models::PlaybackInfoResponse, Error<GetPlaybackInfoError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetPlaybackInfoError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_posted_playback_info(
    ...
    playback_info_dto: Option<crate::models::PlaybackInfoDto>,
) -> Result<crate::models::PlaybackInfoResponse, Error<GetPostedPlaybackInfoError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = auto_open_live_stream {
        local_var_req_builder =
            local_var_req_builder.query(&[("autoOpenLiveStream", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = enable_direct_play {
        local_var_req_builder =
            local_var_req_builder.query(&[("enableDirectPlay", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = enable_direct_stream {
        local_var_req_builder =
            local_var_req_builder.query(&[("enableDirectStream", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = enable_transcoding {
        local_var_req_builder =
            local_var_req_builder.query(&[("enableTranscoding", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = allow_video_stream_copy {
        local_var_req_builder =
            local_var_req_builder.query(&[("allowVideoStreamCopy", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = allow_audio_stream_copy {
        local_var_req_builder =
            local_var_req_builder.query(&[("allowAudioStreamCopy", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetPostedPlaybackInfoError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn open_live_stream(
    ...
    enable_direct_play: Option<bool>,
    enable_direct_stream: Option<bool>,
    open_live_stream_dto: Option<crate::models::OpenLiveStreamDto>,
) -> Result<crate::models::LiveStreamResponse, Error<OpenLiveStreamError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = open_token {
        local_var_req_builder =
            local_var_req_builder.query(&[("openToken", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = user_id {
        local_var_req_builder =
            local_var_req_builder.query(&[("userId", &local_var_str.to_string())]);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<OpenLiveStreamError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
