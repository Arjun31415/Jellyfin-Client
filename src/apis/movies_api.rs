...
pub async fn get_movie_recommendations(
...
) -> Result<Vec<crate::models::RecommendationDto>, Error<GetMovieRecommendationsError>> {
    ...
    if let Some(ref local_var_str) = category_limit {
        local_var_req_builder =
            local_var_req_builder.query(&[("categoryLimit", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = item_limit {
        local_var_req_builder =
            local_var_req_builder.query(&[("itemLimit", &local_var_str.to_string())]);
    }
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetMovieRecommendationsError> =
