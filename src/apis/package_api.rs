...
pub async fn cancel_package_installation(
    ...
    package_id: &str,
) -> Result<(), Error<CancelPackageInstallationError>> {
    ...
    let local_var_uri_str = format!(
        ...
        packageId = crate::apis::urlencode(package_id)
    );
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CancelPackageInstallationError> =
...
pub async fn get_package_info(
...
) -> Result<crate::models::PackageInfo, Error<GetPackageInfoError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = assembly_guid {
        local_var_req_builder =
            local_var_req_builder.query(&[("assemblyGuid", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetPackageInfoError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_packages(
    configuration: &configuration::Configuration,
) -> Result<Vec<crate::models::PackageInfo>, Error<GetPackagesError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetPackagesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_repositories(
    configuration: &configuration::Configuration,
) -> Result<Vec<crate::models::RepositoryInfo>, Error<GetRepositoriesError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetRepositoriesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn install_package(
...
) -> Result<(), Error<InstallPackageError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = repository_url {
        local_var_req_builder =
            local_var_req_builder.query(&[("repositoryUrl", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<InstallPackageError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn set_repositories(
    configuration: &configuration::Configuration,
    repository_info: Vec<crate::models::RepositoryInfo>,
) -> Result<(), Error<SetRepositoriesError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SetRepositoriesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
