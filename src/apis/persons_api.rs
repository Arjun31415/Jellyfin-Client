...
pub async fn get_person(
    ...
    name: &str,
    user_id: Option<&str>,
) -> Result<crate::models::BaseItemDto, Error<GetPersonError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetPersonError> =
...
pub async fn get_persons(
    ...
    appears_in_item_id: Option<&str>,
    user_id: Option<&str>,
    enable_images: Option<bool>,
) -> Result<crate::models::BaseItemDtoQueryResult, Error<GetPersonsError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = exclude_person_types {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(
                &local_var_str
                    .into_iter()
                    .map(|p| ("excludePersonTypes".to_owned(), p.to_string()))
                    .collect::<Vec<(std::string::String, std::string::String)>>(),
            ),
            _ => local_var_req_builder.query(&[(
                "excludePersonTypes",
    ...
    if let Some(ref local_var_str) = appears_in_item_id {
        local_var_req_builder =
            local_var_req_builder.query(&[("appearsInItemId", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = user_id {
        local_var_req_builder =
            local_var_req_builder.query(&[("userId", &local_var_str.to_string())]);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetPersonsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
