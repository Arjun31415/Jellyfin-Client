...
pub async fn mark_played_item(
...
) -> Result<crate::models::UserItemDataDto, Error<MarkPlayedItemError>> {
    ...
    if let Some(ref local_var_str) = date_played {
        local_var_req_builder =
            local_var_req_builder.query(&[("datePlayed", &local_var_str.to_string())]);
    }
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<MarkPlayedItemError> =
...
pub async fn mark_unplayed_item(
    ...
    user_id: &str,
    item_id: &str,
) -> Result<crate::models::UserItemDataDto, Error<MarkUnplayedItemError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<MarkUnplayedItemError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn on_playback_progress(
    ...
    play_method: Option<crate::models::PlayMethod>,
    live_stream_id: Option<&str>,
    play_session_id: Option<&str>,
    repeat_mode: Option<crate::models::RepeatMode>,
    is_paused: Option<bool>,
    is_muted: Option<bool>,
) -> Result<(), Error<OnPlaybackProgressError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = position_ticks {
        local_var_req_builder =
            local_var_req_builder.query(&[("positionTicks", &local_var_str.to_string())]);
    }
    ...
    if let Some(ref local_var_str) = volume_level {
        local_var_req_builder =
            local_var_req_builder.query(&[("volumeLevel", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = play_method {
        local_var_req_builder =
            local_var_req_builder.query(&[("playMethod", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = live_stream_id {
        local_var_req_builder =
            local_var_req_builder.query(&[("liveStreamId", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = play_session_id {
        local_var_req_builder =
            local_var_req_builder.query(&[("playSessionId", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = repeat_mode {
        local_var_req_builder =
            local_var_req_builder.query(&[("repeatMode", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = is_paused {
        local_var_req_builder =
            local_var_req_builder.query(&[("isPaused", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = is_muted {
        local_var_req_builder =
            local_var_req_builder.query(&[("isMuted", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<OnPlaybackProgressError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn on_playback_start(
...
) -> Result<(), Error<OnPlaybackStartError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = can_seek {
        local_var_req_builder =
            local_var_req_builder.query(&[("canSeek", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<OnPlaybackStartError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn on_playback_stopped(
    ...
    live_stream_id: Option<&str>,
    play_session_id: Option<&str>,
) -> Result<(), Error<OnPlaybackStoppedError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = next_media_type {
        local_var_req_builder =
            local_var_req_builder.query(&[("nextMediaType", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = position_ticks {
        local_var_req_builder =
            local_var_req_builder.query(&[("positionTicks", &local_var_str.to_string())]);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<OnPlaybackStoppedError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn ping_playback_session(
    configuration: &configuration::Configuration,
    play_session_id: &str,
) -> Result<(), Error<PingPlaybackSessionError>> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder =
        local_var_req_builder.query(&[("playSessionId", &play_session_id.to_string())]);
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    }
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PingPlaybackSessionError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn report_playback_progress(
    configuration: &configuration::Configuration,
    playback_progress_info: Option<crate::models::PlaybackProgressInfo>,
) -> Result<(), Error<ReportPlaybackProgressError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReportPlaybackProgressError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn report_playback_start(
    configuration: &configuration::Configuration,
    playback_start_info: Option<crate::models::PlaybackStartInfo>,
) -> Result<(), Error<ReportPlaybackStartError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReportPlaybackStartError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn report_playback_stopped(
    configuration: &configuration::Configuration,
    playback_stop_info: Option<crate::models::PlaybackStopInfo>,
) -> Result<(), Error<ReportPlaybackStoppedError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReportPlaybackStoppedError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
