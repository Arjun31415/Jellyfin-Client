...
pub async fn download_remote_image(
    ...
    item_id: &str,
    r#type: crate::models::ImageType,
    image_url: Option<&str>,
) -> Result<(), Error<DownloadRemoteImageError>> {
    ...
    if let Some(ref local_var_str) = image_url {
        local_var_req_builder =
            local_var_req_builder.query(&[("imageUrl", &local_var_str.to_string())]);
    }
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DownloadRemoteImageError> =
...
pub async fn get_remote_image_providers(
    configuration: &configuration::Configuration,
    item_id: &str,
) -> Result<Vec<crate::models::ImageProviderInfo>, Error<GetRemoteImageProvidersError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetRemoteImageProvidersError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_remote_images(
    configuration: &configuration::Configuration,
    item_id: &str,
    r#type: Option<crate::models::ImageType>,
    start_index: Option<i32>,
    limit: Option<i32>,
    provider_name: Option<&str>,
    include_all_languages: Option<bool>,
) -> Result<crate::models::RemoteImageResult, Error<GetRemoteImagesError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = provider_name {
        local_var_req_builder =
            local_var_req_builder.query(&[("providerName", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = include_all_languages {
        local_var_req_builder =
            local_var_req_builder.query(&[("includeAllLanguages", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetRemoteImagesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
