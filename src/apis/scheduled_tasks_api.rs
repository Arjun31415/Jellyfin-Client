...
pub async fn get_task(
    ...
    task_id: &str,
) -> Result<crate::models::TaskInfo, Error<GetTaskError>> {
...
pub async fn get_tasks(
...
) -> Result<Vec<crate::models::TaskInfo>, Error<GetTasksError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = is_enabled {
        local_var_req_builder =
            local_var_req_builder.query(&[("isEnabled", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
...
pub async fn start_task(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<StartTaskError> =
...
pub async fn update_task(
    configuration: &configuration::Configuration,
    task_id: &str,
    task_trigger_info: Vec<crate::models::TaskTriggerInfo>,
) -> Result<(), Error<UpdateTaskError>> {
    let local_var_configuration = configuration;
