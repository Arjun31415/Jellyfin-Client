...
pub async fn add_user_to_session(
    ...
    session_id: &str,
    user_id: &str,
) -> Result<(), Error<AddUserToSessionError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AddUserToSessionError> =
...
pub async fn display_content(
    configuration: &configuration::Configuration,
    session_id: &str,
    item_type: crate::models::BaseItemKind,
    item_id: &str,
    item_name: &str,
) -> Result<(), Error<DisplayContentError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DisplayContentError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_auth_providers(
    configuration: &configuration::Configuration,
) -> Result<Vec<crate::models::NameIdPair>, Error<GetAuthProvidersError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetAuthProvidersError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_password_reset_providers(
    configuration: &configuration::Configuration,
) -> Result<Vec<crate::models::NameIdPair>, Error<GetPasswordResetProvidersError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetPasswordResetProvidersError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_sessions(
    configuration: &configuration::Configuration,
    controllable_by_user_id: Option<&str>,
    device_id: Option<&str>,
    active_within_seconds: Option<i32>,
) -> Result<Vec<crate::models::SessionInfo>, Error<GetSessionsError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = controllable_by_user_id {
        local_var_req_builder =
            local_var_req_builder.query(&[("controllableByUserId", &local_var_str.to_string())]);
    }
    ...
    if let Some(ref local_var_str) = active_within_seconds {
        local_var_req_builder =
            local_var_req_builder.query(&[("activeWithinSeconds", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
...
pub async fn play(
    configuration: &configuration::Configuration,
    session_id: &str,
    play_command: crate::models::PlayCommand,
    ...
    local_var_req_builder =
        local_var_req_builder.query(&[("playCommand", &play_command.to_string())]);
    ...
    if let Some(ref local_var_str) = start_position_ticks {
        local_var_req_builder =
            local_var_req_builder.query(&[("startPositionTicks", &local_var_str.to_string())]);
    }
    ...
    if let Some(ref local_var_str) = audio_stream_index {
        local_var_req_builder =
            local_var_req_builder.query(&[("audioStreamIndex", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = subtitle_stream_index {
        local_var_req_builder =
            local_var_req_builder.query(&[("subtitleStreamIndex", &local_var_str.to_string())]);
    }
...
pub async fn post_capabilities(
    ...
    if let Some(ref local_var_str) = playable_media_types {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(
                &local_var_str
                    .into_iter()
                    .map(|p| ("playableMediaTypes".to_owned(), p.to_string()))
                    .collect::<Vec<(std::string::String, std::string::String)>>(),
            ),
            _ => local_var_req_builder.query(&[(
                "playableMediaTypes",
    ...
    if let Some(ref local_var_str) = supported_commands {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(
                &local_var_str
                    .into_iter()
                    .map(|p| ("supportedCommands".to_owned(), p.to_string()))
                    .collect::<Vec<(std::string::String, std::string::String)>>(),
            ),
            _ => local_var_req_builder.query(&[(
                "supportedCommands",
    ...
    if let Some(ref local_var_str) = supports_media_control {
        local_var_req_builder =
            local_var_req_builder.query(&[("supportsMediaControl", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = supports_sync {
        local_var_req_builder =
            local_var_req_builder.query(&[("supportsSync", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = supports_persistent_identifier {
        local_var_req_builder = local_var_req_builder
            .query(&[("supportsPersistentIdentifier", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PostCapabilitiesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn post_full_capabilities(
    configuration: &configuration::Configuration,
    client_capabilities_dto: crate::models::ClientCapabilitiesDto,
    id: Option<&str>,
) -> Result<(), Error<PostFullCapabilitiesError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PostFullCapabilitiesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn remove_user_from_session(
    ...
    session_id: &str,
    user_id: &str,
) -> Result<(), Error<RemoveUserFromSessionError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<RemoveUserFromSessionError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn report_session_ended(
    configuration: &configuration::Configuration,
) -> Result<(), Error<ReportSessionEndedError>> {
    let local_var_client = &configuration.client;
    let device_name = whoami::devicename().replace(' ', "_");
    let local_var_uri_str = format!("{}/Sessions/Logout", configuration.base_path);
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    if let Some(ref local_var_apikey) = configuration.api_key {
        ...
        local_var_req_builder = local_var_req_builder
            ...
            format!("MediaBrowser Client=\"jellyfin-rs\", Device=\"{}\", DeviceId=\"{:x}\", Version=\"1\", Token=\"{}\"",
            device_name,
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReportSessionEndedError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn report_viewing(
...
) -> Result<(), Error<ReportViewingError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReportViewingError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn send_full_general_command(
    configuration: &configuration::Configuration,
    session_id: &str,
    general_command: crate::models::GeneralCommand,
) -> Result<(), Error<SendFullGeneralCommandError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SendFullGeneralCommandError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn send_general_command(
    configuration: &configuration::Configuration,
    session_id: &str,
    command: crate::models::GeneralCommandType,
) -> Result<(), Error<SendGeneralCommandError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SendGeneralCommandError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn send_message_command(
    configuration: &configuration::Configuration,
    session_id: &str,
    message_command: crate::models::MessageCommand,
) -> Result<(), Error<SendMessageCommandError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SendMessageCommandError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn send_playstate_command(
    configuration: &configuration::Configuration,
    session_id: &str,
    command: crate::models::PlaystateCommand,
    seek_position_ticks: Option<i64>,
    controlling_user_id: Option<&str>,
) -> Result<(), Error<SendPlaystateCommandError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!(
        ...
        local_var_configuration.base_path,
        sessionId = crate::apis::urlencode(session_id),
        command = command.to_string().to_string()
    );
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    if let Some(ref local_var_str) = seek_position_ticks {
        local_var_req_builder =
            local_var_req_builder.query(&[("seekPositionTicks", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = controlling_user_id {
        local_var_req_builder =
            local_var_req_builder.query(&[("controllingUserId", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SendPlaystateCommandError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn send_system_command(
    ...
    session_id: &str,
    command: crate::models::GeneralCommandType,
) -> Result<(), Error<SendSystemCommandError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SendSystemCommandError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
