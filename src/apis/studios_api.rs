...
pub async fn get_studio(
    ...
    name: &str,
    user_id: Option<&str>,
) -> Result<crate::models::BaseItemDto, Error<GetStudioError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetStudioError> =
...
pub async fn get_studios(
...
) -> Result<crate::models::BaseItemDtoQueryResult, Error<GetStudiosError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetStudiosError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
