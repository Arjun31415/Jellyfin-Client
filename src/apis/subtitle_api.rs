...
pub async fn delete_subtitle(
    ...
    item_id: &str,
    index: i32,
) -> Result<(), Error<DeleteSubtitleError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeleteSubtitleError> =
...
pub async fn download_remote_subtitles(
    ...
    item_id: &str,
    subtitle_id: &str,
) -> Result<(), Error<DownloadRemoteSubtitlesError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!(
        ...
        local_var_configuration.base_path,
        itemId = crate::apis::urlencode(item_id),
        subtitleId = crate::apis::urlencode(subtitle_id)
    );
    let mut local_var_req_builder =
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DownloadRemoteSubtitlesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_fallback_font(
    configuration: &configuration::Configuration,
    name: &str,
) -> Result<std::path::PathBuf, Error<GetFallbackFontError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetFallbackFontError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_fallback_font_list(
    configuration: &configuration::Configuration,
) -> Result<Vec<crate::models::FontFile>, Error<GetFallbackFontListError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetFallbackFontListError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_remote_subtitles(
    configuration: &configuration::Configuration,
    id: &str,
) -> Result<std::path::PathBuf, Error<GetRemoteSubtitlesError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetRemoteSubtitlesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_subtitle(
...
) -> Result<std::path::PathBuf, Error<GetSubtitleError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!(
        ...
        local_var_configuration.base_path,
        routeItemId = crate::apis::urlencode(route_item_id),
        routeMediaSourceId = crate::apis::urlencode(route_media_source_id),
        routeIndex = route_index,
        routeFormat = crate::apis::urlencode(route_format)
    );
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if let Some(ref local_var_str) = end_position_ticks {
        local_var_req_builder =
            local_var_req_builder.query(&[("endPositionTicks", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = copy_timestamps {
        local_var_req_builder =
            local_var_req_builder.query(&[("copyTimestamps", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = add_vtt_time_map {
        local_var_req_builder =
            local_var_req_builder.query(&[("addVttTimeMap", &local_var_str.to_string())]);
    }
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetSubtitleError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_subtitle_playlist(
    ...
    media_source_id: &str,
    segment_length: i32,
) -> Result<std::path::PathBuf, Error<GetSubtitlePlaylistError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!(
        ...
        itemId = crate::apis::urlencode(item_id),
        index = index,
        mediaSourceId = crate::apis::urlencode(media_source_id)
    );
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());

    local_var_req_builder =
        local_var_req_builder.query(&[("segmentLength", &segment_length.to_string())]);
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    }
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetSubtitlePlaylistError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_subtitle_with_ticks(
    ...
    copy_timestamps: Option<bool>,
    add_vtt_time_map: Option<bool>,
) -> Result<std::path::PathBuf, Error<GetSubtitleWithTicksError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetSubtitleWithTicksError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn search_remote_subtitles(
...
) -> Result<Vec<crate::models::RemoteSubtitleInfo>, Error<SearchRemoteSubtitlesError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = is_perfect_match {
        local_var_req_builder =
            local_var_req_builder.query(&[("isPerfectMatch", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SearchRemoteSubtitlesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn upload_subtitle(
    configuration: &configuration::Configuration,
    item_id: &str,
    upload_subtitle_dto: crate::models::UploadSubtitleDto,
) -> Result<(), Error<UploadSubtitleError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UploadSubtitleError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
