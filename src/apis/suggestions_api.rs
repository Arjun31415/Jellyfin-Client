...
pub async fn get_suggestions(
    ...
    r#type: Option<Vec<crate::models::BaseItemKind>>,
    start_index: Option<i32>,
    limit: Option<i32>,
    enable_total_record_count: Option<bool>,
) -> Result<crate::models::BaseItemDtoQueryResult, Error<GetSuggestionsError>> {
    ...
    if let Some(ref local_var_str) = media_type {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(
                &local_var_str
                    .into_iter()
                    .map(|p| ("mediaType".to_owned(), p.to_string()))
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetSuggestionsError> =
