...
pub async fn sync_play_buffering(
    ...
    buffer_request_dto: crate::models::BufferRequestDto,
) -> Result<(), Error<SyncPlayBufferingError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SyncPlayBufferingError> =
...
pub async fn sync_play_create_group(
    configuration: &configuration::Configuration,
    new_group_request_dto: crate::models::NewGroupRequestDto,
) -> Result<(), Error<SyncPlayCreateGroupError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SyncPlayCreateGroupError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn sync_play_get_groups(
    configuration: &configuration::Configuration,
) -> Result<Vec<crate::models::GroupInfoDto>, Error<SyncPlayGetGroupsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SyncPlayGetGroupsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn sync_play_join_group(
    configuration: &configuration::Configuration,
    join_group_request_dto: crate::models::JoinGroupRequestDto,
) -> Result<(), Error<SyncPlayJoinGroupError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SyncPlayJoinGroupError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn sync_play_leave_group(
    configuration: &configuration::Configuration,
) -> Result<(), Error<SyncPlayLeaveGroupError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SyncPlayLeaveGroupError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn sync_play_move_playlist_item(
    configuration: &configuration::Configuration,
    move_playlist_item_request_dto: crate::models::MovePlaylistItemRequestDto,
) -> Result<(), Error<SyncPlayMovePlaylistItemError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SyncPlayMovePlaylistItemError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn sync_play_next_item(
    configuration: &configuration::Configuration,
    next_item_request_dto: crate::models::NextItemRequestDto,
) -> Result<(), Error<SyncPlayNextItemError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SyncPlayNextItemError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn sync_play_pause(
    configuration: &configuration::Configuration,
) -> Result<(), Error<SyncPlayPauseError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SyncPlayPauseError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn sync_play_ping(
    configuration: &configuration::Configuration,
    ping_request_dto: crate::models::PingRequestDto,
) -> Result<(), Error<SyncPlayPingError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SyncPlayPingError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn sync_play_previous_item(
    configuration: &configuration::Configuration,
    previous_item_request_dto: crate::models::PreviousItemRequestDto,
) -> Result<(), Error<SyncPlayPreviousItemError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SyncPlayPreviousItemError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn sync_play_queue(
    configuration: &configuration::Configuration,
    queue_request_dto: crate::models::QueueRequestDto,
) -> Result<(), Error<SyncPlayQueueError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SyncPlayQueueError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn sync_play_ready(
    configuration: &configuration::Configuration,
    ready_request_dto: crate::models::ReadyRequestDto,
) -> Result<(), Error<SyncPlayReadyError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SyncPlayReadyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn sync_play_remove_from_playlist(
    configuration: &configuration::Configuration,
    remove_from_playlist_request_dto: crate::models::RemoveFromPlaylistRequestDto,
) -> Result<(), Error<SyncPlayRemoveFromPlaylistError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SyncPlayRemoveFromPlaylistError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn sync_play_seek(
    configuration: &configuration::Configuration,
    seek_request_dto: crate::models::SeekRequestDto,
) -> Result<(), Error<SyncPlaySeekError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SyncPlaySeekError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn sync_play_set_ignore_wait(
    configuration: &configuration::Configuration,
    ignore_wait_request_dto: crate::models::IgnoreWaitRequestDto,
) -> Result<(), Error<SyncPlaySetIgnoreWaitError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SyncPlaySetIgnoreWaitError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn sync_play_set_new_queue(
    configuration: &configuration::Configuration,
    play_request_dto: crate::models::PlayRequestDto,
) -> Result<(), Error<SyncPlaySetNewQueueError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SyncPlaySetNewQueueError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn sync_play_set_playlist_item(
    configuration: &configuration::Configuration,
    set_playlist_item_request_dto: crate::models::SetPlaylistItemRequestDto,
) -> Result<(), Error<SyncPlaySetPlaylistItemError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SyncPlaySetPlaylistItemError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn sync_play_set_repeat_mode(
    configuration: &configuration::Configuration,
    set_repeat_mode_request_dto: crate::models::SetRepeatModeRequestDto,
) -> Result<(), Error<SyncPlaySetRepeatModeError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SyncPlaySetRepeatModeError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn sync_play_set_shuffle_mode(
    configuration: &configuration::Configuration,
    set_shuffle_mode_request_dto: crate::models::SetShuffleModeRequestDto,
) -> Result<(), Error<SyncPlaySetShuffleModeError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SyncPlaySetShuffleModeError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn sync_play_stop(
    configuration: &configuration::Configuration,
) -> Result<(), Error<SyncPlayStopError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SyncPlayStopError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn sync_play_unpause(
    configuration: &configuration::Configuration,
) -> Result<(), Error<SyncPlayUnpauseError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SyncPlayUnpauseError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
