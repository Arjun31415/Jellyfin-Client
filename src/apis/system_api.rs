...
pub async fn get_endpoint_info(
...
) -> Result<crate::models::EndPointInfo, Error<GetEndpointInfoError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetEndpointInfoError> =
...
pub async fn get_log_file(
    configuration: &configuration::Configuration,
    name: &str,
) -> Result<std::path::PathBuf, Error<GetLogFileError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetLogFileError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_ping_system(
    configuration: &configuration::Configuration,
) -> Result<String, Error<GetPingSystemError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetPingSystemError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_public_system_info(
    configuration: &configuration::Configuration,
) -> Result<crate::models::PublicSystemInfo, Error<GetPublicSystemInfoError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetPublicSystemInfoError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_server_logs(
    configuration: &configuration::Configuration,
) -> Result<Vec<crate::models::LogFile>, Error<GetServerLogsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetServerLogsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_system_info(
    configuration: &configuration::Configuration,
) -> Result<crate::models::SystemInfo, Error<GetSystemInfoError>> {
    let local_var_configuration = configuration;
...
pub async fn get_wake_on_lan_info(
    configuration: &configuration::Configuration,
) -> Result<Vec<crate::models::WakeOnLanInfo>, Error<GetWakeOnLanInfoError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetWakeOnLanInfoError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn post_ping_system(
    configuration: &configuration::Configuration,
) -> Result<String, Error<PostPingSystemError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PostPingSystemError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn restart_application(
    configuration: &configuration::Configuration,
) -> Result<(), Error<RestartApplicationError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<RestartApplicationError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn shutdown_application(
    configuration: &configuration::Configuration,
) -> Result<(), Error<ShutdownApplicationError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ShutdownApplicationError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
