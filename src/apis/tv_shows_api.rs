...
pub async fn get_episodes(
    ...
    sort_by: Option<&str>,
) -> Result<crate::models::BaseItemDtoQueryResult, Error<GetEpisodesError>> {
    ...
    let local_var_uri_str = format!(
        ...
        seriesId = crate::apis::urlencode(series_id)
    );
    ...
    if let Some(ref local_var_str) = season_id {
        local_var_req_builder =
            local_var_req_builder.query(&[("seasonId", &local_var_str.to_string())]);
    }
    ...
    if let Some(ref local_var_str) = start_item_id {
        local_var_req_builder =
            local_var_req_builder.query(&[("startItemId", &local_var_str.to_string())]);
    }
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetEpisodesError> =
...
pub async fn get_next_up(
...
) -> Result<crate::models::BaseItemDtoQueryResult, Error<GetNextUpError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = series_id {
        local_var_req_builder =
            local_var_req_builder.query(&[("seriesId", &local_var_str.to_string())]);
    }
    ...
    if let Some(ref local_var_str) = next_up_date_cutoff {
        local_var_req_builder =
            local_var_req_builder.query(&[("nextUpDateCutoff", &local_var_str.to_string())]);
    }
    ...
    if let Some(ref local_var_str) = disable_first_episode {
        local_var_req_builder =
            local_var_req_builder.query(&[("disableFirstEpisode", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = enable_rewatching {
        local_var_req_builder =
            local_var_req_builder.query(&[("enableRewatching", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetNextUpError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_seasons(
    ...
    enable_image_types: Option<Vec<crate::models::ImageType>>,
    enable_user_data: Option<bool>,
) -> Result<crate::models::BaseItemDtoQueryResult, Error<GetSeasonsError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = is_special_season {
        local_var_req_builder =
            local_var_req_builder.query(&[("isSpecialSeason", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = is_missing {
        local_var_req_builder =
            local_var_req_builder.query(&[("isMissing", &local_var_str.to_string())]);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetSeasonsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_upcoming_episodes(
    ...
    enable_image_types: Option<Vec<crate::models::ImageType>>,
    enable_user_data: Option<bool>,
) -> Result<crate::models::BaseItemDtoQueryResult, Error<GetUpcomingEpisodesError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetUpcomingEpisodesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
