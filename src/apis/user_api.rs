...
pub async fn authenticate_user(
    ...
    pw: &str,
    password: Option<&str>,
) -> Result<crate::models::AuthenticationResult, Error<AuthenticateUserError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AuthenticateUserError> =
...
pub async fn authenticate_user_by_name(
    configuration: &configuration::Configuration,
    authenticate_user_by_name: crate::models::AuthenticateUserByName,
) -> Result<crate::models::AuthenticationResult, Error<AuthenticateUserByNameError>> {
    let device_name = whoami::devicename().replace(' ', "_");
    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/Users/AuthenticateByName", configuration.base_path);
    let local_var_req=local_var_client
        .post(local_var_uri_str)
        .json(&authenticate_user_by_name)
        .header("Authorization",
            format!("MediaBrowser Client=\"jellyfin-rs\", Device=\"{}\", DeviceId=\"{:x}\", Version=\"1\"",
            device_name,
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AuthenticateUserByNameError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn authenticate_with_quick_connect(
    configuration: &configuration::Configuration,
    quick_connect_dto: crate::models::QuickConnectDto,
) -> Result<crate::models::AuthenticationResult, Error<AuthenticateWithQuickConnectError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AuthenticateWithQuickConnectError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn create_user_by_name(
    configuration: &configuration::Configuration,
    create_user_by_name: crate::models::CreateUserByName,
) -> Result<crate::models::UserDto, Error<CreateUserByNameError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateUserByNameError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn forgot_password(
    configuration: &configuration::Configuration,
    forgot_password_dto: crate::models::ForgotPasswordDto,
) -> Result<crate::models::ForgotPasswordResult, Error<ForgotPasswordError>> {
    let local_var_configuration = configuration;
...
pub async fn forgot_password_pin(
    configuration: &configuration::Configuration,
    forgot_password_pin_dto: crate::models::ForgotPasswordPinDto,
) -> Result<crate::models::PinRedeemResult, Error<ForgotPasswordPinError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ForgotPasswordPinError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_current_user(
    configuration: &configuration::Configuration,
) -> Result<crate::models::UserDto, Error<GetCurrentUserError>> {
    let local_var_configuration = configuration;
...
pub async fn get_public_users(
    configuration: &configuration::Configuration,
) -> Result<Vec<crate::models::UserDto>, Error<GetPublicUsersError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetPublicUsersError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_user_by_id(
    configuration: &configuration::Configuration,
    user_id: &str,
) -> Result<crate::models::UserDto, Error<GetUserByIdError>> {
    let local_var_configuration = configuration;
...
pub async fn get_users(
...
) -> Result<Vec<crate::models::UserDto>, Error<GetUsersError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = is_disabled {
        local_var_req_builder =
            local_var_req_builder.query(&[("isDisabled", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
...
pub async fn update_user_configuration(
    configuration: &configuration::Configuration,
    user_id: &str,
    user_configuration: crate::models::UserConfiguration,
) -> Result<(), Error<UpdateUserConfigurationError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdateUserConfigurationError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn update_user_easy_password(
    configuration: &configuration::Configuration,
    user_id: &str,
    update_user_easy_password: crate::models::UpdateUserEasyPassword,
) -> Result<(), Error<UpdateUserEasyPasswordError>> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder = local_var_req_builder.json(&update_user_easy_password);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdateUserEasyPasswordError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn update_user_password(
    configuration: &configuration::Configuration,
    user_id: &str,
    update_user_password: crate::models::UpdateUserPassword,
...
pub async fn update_user_policy(
    configuration: &configuration::Configuration,
    user_id: &str,
    user_policy: crate::models::UserPolicy,
) -> Result<(), Error<UpdateUserPolicyError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdateUserPolicyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
