...
pub async fn delete_alternate_sources(
    ...
    item_id: &str,
) -> Result<(), Error<DeleteAlternateSourcesError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeleteAlternateSourcesError> =
...
pub async fn get_additional_part(
    ...
    item_id: &str,
    user_id: Option<&str>,
) -> Result<crate::models::BaseItemDtoQueryResult, Error<GetAdditionalPartError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = user_id {
        local_var_req_builder = local_var_req_builder
            .query(&[("userId", serde_json::to_string(&local_var_str).unwrap())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetAdditionalPartError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_video_stream(
...
) -> Result<std::path::PathBuf, Error<GetVideoStreamError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetVideoStreamError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_video_stream_by_container(
    ...
    context: Option<crate::models::EncodingContext>,
    stream_options: Option<::std::collections::HashMap<String, String>>,
) -> Result<std::path::PathBuf, Error<GetVideoStreamByContainerError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetVideoStreamByContainerError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn head_video_stream(
    ...
    context: Option<crate::models::EncodingContext>,
    stream_options: Option<::std::collections::HashMap<String, String>>,
) -> Result<std::path::PathBuf, Error<HeadVideoStreamError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<HeadVideoStreamError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn head_video_stream_by_container(
    ...
    context: Option<crate::models::EncodingContext>,
    stream_options: Option<::std::collections::HashMap<String, String>>,
) -> Result<std::path::PathBuf, Error<HeadVideoStreamByContainerError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<HeadVideoStreamByContainerError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn merge_versions(
    configuration: &configuration::Configuration,
    ids: Vec<uuid::Uuid>,
) -> Result<(), Error<MergeVersionsError>> {
    let local_var_configuration = configuration;
