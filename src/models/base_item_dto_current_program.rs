...
/// BaseItemDtoCurrentProgram : Gets or sets the current program.

#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct BaseItemDtoCurrentProgram {
...
impl BaseItemDtoCurrentProgram {
    /// Gets or sets the current program.
    pub fn new() -> BaseItemDtoCurrentProgram {
