...
pub struct EncodingOptions {
    ...
    pub hardware_acceleration_type: Option<Option<String>>,
    ...
    pub tonemapping_algorithm: Option<Option<String>>,
    #[serde(
    ...
    pub tonemapping_mode: Option<Option<String>>,
    #[serde(
    ...
    pub tonemapping_range: Option<Option<String>>,
    ...
    pub encoder_preset: Option<Option<String>>,
    #[serde(
    ...
    pub deinterlace_method: Option<Option<String>>,
    #[serde(
