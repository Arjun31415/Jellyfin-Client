...
pub struct TaskInfo {
    ...
    pub state: Option<crate::models::TaskState>,
    ...
    pub last_execution_result: Option<Option<Box<crate::models::TaskInfoLastExecutionResult>>>,
    ...
    pub triggers: Option<Option<Vec<crate::models::TaskTriggerInfo>>>,
